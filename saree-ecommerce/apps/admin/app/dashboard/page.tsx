...
import { Alert, Dialog } from '@/components/enterprise/FeedbackComponents';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5">
        <Card>
          ...
          <CardContent>
            ...
            <p className={`text-xs text-muted-foreground ${stats?.revenue.change > 0 ? 'text-emerald-600' : 'text-red-500'}`}>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatNumber(stats?.orders.value)}</div>
            <p className={`text-xs text-muted-foreground ${stats?.orders.change > 0 ? 'text-emerald-600' : 'text-red-500'}`}>
              {stats?.orders.change > 0 ? '+' : ''}{stats?.orders.change}% from last month
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatNumber(stats?.customers.value)}</div>
            <p className={`text-xs text-muted-foreground ${stats?.customers.change > 0 ? 'text-emerald-600' : 'text-red-500'}`}>
              {stats?.customers.change > 0 ? '+' : ''}{stats?.customers.change}% from last month
            </p>
          </CardContent>
        </Card>
        <Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatNumber(stats?.inventory.value)}</div>
            <p className="text-xs text-muted-foreground">{stats?.inventory.lowStock} low stock items</p>
          </CardContent>
        </Card>
      </div>
