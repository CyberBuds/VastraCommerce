// app/gift-cards/components/gift-card-table.tsx
'use client';
...
import { useGetGiftCards } from '@/features/marketing/hooks/useGiftCards';
...
export function GiftCardsTable() {
  ...
  const { data, isLoading, isError } = useGetGiftCards();
  ...
  return (
    <div className="space-y-4">
      <DataTableToolbar table={table} filterKeys={['code', 'status', 'recipientEmail']} />
