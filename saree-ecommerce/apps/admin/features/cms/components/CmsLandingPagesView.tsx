          ...
          return (
            <div key={page.id} className="p-5 rounded-2xl border border-slate-200 dark:border-zinc-850 bg-white dark:bg-zinc-900 shadow-2xs space-y-4 flex flex-col justify-between">
              <div>
                ...
                {heroSection && <p className="text-xs text-slate-500 dark:text-zinc-400 mt-1">{heroSection.title}</p>}
              </div>
              ...
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 space-y-2">
                <div className="flex justify-between text-xs">
                  ...
                  <strong className="text-slate-800 dark:text-zinc-200">{heroSection?.settings.ctaText}</strong>
                </div>
                <div className="flex justify-between text-xs">
                  <span className="text-slate-500">Views:</span>
                  <strong className="text-emerald-600 dark:text-emerald-400 font-bold">{page.views.toLocaleString()} views</strong>
                </div>
              </div>
