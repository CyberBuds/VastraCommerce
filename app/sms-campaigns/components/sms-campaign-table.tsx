// app/sms-campaigns/components/sms-campaign-table.tsx
'use client';
...
import { useGetSmsCampaigns } from '@/features/marketing/hooks/useSmsCampaigns';
...
export function SmsCampaignsTable() {
  ...
  const { data, isLoading, isError } = useGetSmsCampaigns({
      // pass filters here
  });
